...
var ARDashboardComponent = /** @class */ (function () {
    ...
    ARDashboardComponent.prototype.clearForm = function () {
    ...
    ARDashboardComponent.prototype.findListsAR = function () {
        var _this = this;
        this.showSpinner = true;
        var admissionDate = JSON.stringify(this.detailsToFind.admissionDate);
        var admissionD = admissionDate.slice(1, 11);
        var data = {
            currentUserID: this.detailsToFind.hospitalName,
...
var LandingComponent = /** @class */ (function () {
    ...
    LandingComponent.prototype.getCurrentUser = function () {
    ...
    LoginComponent.prototype.goToGateway = function (v) {
        ...
        this.dataService.postData(this.baseUrl + "/api/v1/adminUsers/login", v).subscribe(function (res) {
            ...
            if (_this.userCridentials.code === 200) {
                ...
                localStorage.setItem('currentUser', JSON.stringify({ token: _this.userCridentials.token, userDetails: _this.userCridentials.data }));
